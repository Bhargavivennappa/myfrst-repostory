          ...
          <div class="container">
            ...
            >
              <ul class="nav navbar-nav menu_nav ml-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="examadminlogin.html">Admin Login</a>
                </li>
				<li class="nav-item active">
                  <a class="nav-link" href="examstudent.html">Student</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="examfaculty.html">Faculty</a>
                </li>
				<li class="nav-item">
            ...
            <div class="col-lg-6">
              <div class="banner_content text-center">
                ...
                <div class="page_link">
                  ...
                  <a style="font-size:20px;"href="examadminlogin.html">Student</a>
                </div>
              </div>
            </div>
          </div>
