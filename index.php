...
<html lang="en">
  <head>
    ...
    <title>Take an Exam::register</title>
    <!-- Bootstrap CSS -->
          ...
          <div class="container">
            ...
            >
              <ul class="nav navbar-nav menu_nav ml-auto">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="aboutus1.html">About</a>
                </li>
                <li class="nav-item">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="name">College:</label>  
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label title1" for="email">Email:</label>
  <div class="col-md-12">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="mob">Mobile Number:</label>  
  <div class="col-md-12">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="cpassword">Confirm Password:</label>
  <div class="col-md-12">
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" value="sign up" class="btn btn-default btn-danger"/>
  </div>
</div>
